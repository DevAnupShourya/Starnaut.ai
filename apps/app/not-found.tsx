...
export default function Notfound() {
    ...
    return (
        <section className="w-screen h-screen max-w-screen-xl mx-auto grid place-items-center">
            <div className="container px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
                <div className="w-full lg:w-1/2 max-lg:text-center">
                    <p className="text-sm font-medium text-destructive">404 error</p>
                    <h1 className="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">Page not found</h1>
                    <p className="mt-4 text-gray-500 dark:text-gray-400">Sorry, the page you are looking for doesn't exist.
                        <br /> Here are some helpful links:
                    </p>

                    <div className="max-w-fit flex items-center mt-6 gap-x-3 max-lg:mx-auto">
                        <Button variant='outline' className="gap-1" onClick={handleGoBack}>
                ...
                <div className="relative w-full mt-12 lg:w-1/2 lg:mt-0 max-md:text-center">
                    {/* <Image height={20} width={30}  src="/images/components/illustration.svg" alt=""> */}
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-full max-w-lg max-lg:mx-auto" width="514" height="164" viewBox="0 0 514 164" fill="none">
